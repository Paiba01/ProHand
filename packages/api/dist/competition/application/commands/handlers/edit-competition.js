...
let EditCompetitionHandler = exports.EditCompetitionHandler = class EditCompetitionHandler {
    ...
    async execute(command) {
        ...
        const competitionCategory = category_1.Category.fromString(command.category);
        if (competitionCategory.isErr())
            return (0, neverthrow_1.err)(competitionCategory.error);
        const editedCompetition = competition_1.Competition.create({
