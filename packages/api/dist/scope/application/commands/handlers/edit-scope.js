...
const edit_scope_1 = require("../edit-scope");
let EditScopeHandler = class EditScopeHandler {
    ...
    async execute(command) {
        ...
        const editedScope = scope_1.default.create({
            description: scopeDescription,
            id: scopeId.value,
            name: scopeName.value,
        });
        return (0, neverthrow_1.ok)(await this.scopes.edit(editedScope));
    }
};
EditScopeHandler = __decorate([
    (0, cqrs_1.CommandHandler)(edit_scope_1.default),
    __param(0, (0, common_1.Inject)(scopes_1.default)),
    __param(1, (0, common_1.Inject)(finder_1.default)),
    __metadata("design:paramtypes", [Object, Object])
], EditScopeHandler);
exports.default = EditScopeHandler;
